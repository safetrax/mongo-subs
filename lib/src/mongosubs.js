...
var MongoSubs = function(oplog, queryFilterCreator) {
  this._mapWriterSubs = {};
  this._oplog = oplog;
  var self = this;
...
MongoSubs.prototype.subscribe = function(ns, findQuery) {
  var subscription = new Subscription(this._oplog.filter(ns), this._createQueryFilter(findQuery));
  return subscription;
};

/**
 * Subscription that holds the info about the {MongoSubs#subscribe} could be stored for
 ...
 */
var Subscription = MongoSubs.Subscription = function(filterOplog, queryFilter) {
